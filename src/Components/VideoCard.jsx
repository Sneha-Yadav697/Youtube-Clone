    ...
    <>
      <div className="flex flex-wrap " key={item.id}>
        <div
          className={` w-80  ${
            open === false
              ? "sm:w-[80%]  md:w-[90%] lg:w-[89%] xl:w-[89%] "
              : "sm:w-[80%] md:w-[85%]  lg:w-[91%]  xl:w-[81%] "
          }  m-3 h-96 rounded-2xl shadow-lg shadow-gray-300 ${
            theme && "shadow-none text-white "
          } `}
        >
              ...
              <div>
                <div className="w-8 rounded-full mt-2 ">
                  <img
                    ...
                    src="https://yt3.ggpht.com/yti/ANjgQV_i62RUkHRGXFomq7B6AXMWpRi03Mltu6HfW7lXVFk=s88-c-k-c0x00ffffff-no-rj"
                    alt=""
                  />
                </div>
              </div>
              <div className="w-full h-12 overflow-hidden">
                <p className="title font-medium text-left ml-2 ">
                  {title.split(" ").slice(0, 10).join(" ") + "..."}{" "}
                </p>
              </div>
            </div>
            <div
              className={`${theme && "text-gray-100 "}  ml-10 text-gray-500`}
            >
